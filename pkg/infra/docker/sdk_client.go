...
// All matching containers are returned regardless of state (running, exited, created, etc.).
// Callers that only want non-running containers should filter by state themselves.
